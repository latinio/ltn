...
In order to support loading of multiple wallets in latinio-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is latinio.cpp.
...
Changes to latinio.cpp
----------------------
latinio.cpp is the entry point into latinio-qt, and as such, will require some minor modifications to provide hooks for
