...
This mechanism has been integrated into Bitcore-Node-LTN which allows for notification to be broadcast through Insight API in one of two ways:
* WebSocket: [https://github.com/LTN-Project/insight-api-latinio#web-socket-api](https://github.com/LTN-Project/insight-api-latinio#web-socket-api) 
* API: [https://github.com/LTN-Project/insight-api-latinio#swifttx-transactions](https://github.com/LTN-Project/insight-api-latinio#swifttx-transactions) 
...
By default, the Latinio Core daemon will launch using the following constant:

```
static const int DEFAULT_SWIFTTX_DEPTH = 5;
```

This value can be overridden by passing the following argument to the Latinio Core daemon:
