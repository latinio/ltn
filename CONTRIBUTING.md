Contributing to Latinio Core
============================

The Latinio Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Latinio Core project, and is not to be
confused with overall LTN Network Protocol consensus changes.

Whether a pull request is merged into Latinio Core rests with the project merge
...
Patches that change LTN consensus rules are considerably more involved than
...
Where a patch set proposes to change the LTN consensus, it must have been
...
The project leader is the release manager for each Latinio Core release.
