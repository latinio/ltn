...
#   c) node1 mines 32 blocks, so now node 0 has 60001latinio, node 1 has 4250latinio, node2 has none.
#   d) node0 sends 601 latinio to node2, in two transactions (301 latinio, then 300 latinio).
