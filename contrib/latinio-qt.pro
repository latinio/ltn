...
RESOURCES += src/qt/latinio.qrc src/qt/latinio_locale.qrc

TRANSLATIONS += src/qt/locale/latinio_bg.ts \
                src/qt/locale/latinio_de.ts \
                src/qt/locale/latinio_en.ts \
                src/qt/locale/latinio_es.ts \
                src/qt/locale/latinio_fi.ts \
                src/qt/locale/latinio_fr.ts \
                src/qt/locale/latinio_it.ts \
                src/qt/locale/latinio_ja.ts \
                src/qt/locale/latinio_pl.ts \
                src/qt/locale/latinio_pt.ts \
                src/qt/locale/latinio_ru.ts \
                src/qt/locale/latinio_sk.ts \
                src/qt/locale/latinio_sv.ts \
                src/qt/locale/latinio_vi.ts \
                src/qt/locale/latinio_zh_CN.ts \
                src/qt/locale/latinio_zh_TW.ts
