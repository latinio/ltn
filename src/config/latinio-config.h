/* src/config/latinio-config.h.  Generated from latinio-config.h.in by configure.  */
/* src/config/latinio-config.h.in.  Generated from configure.ac by autoheader.  */
...
#define PACKAGE_BUGREPORT "latinio.io"

/* Define to the full name of this package. */
#define PACKAGE_NAME "Latinio Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "Latinio Core 1.0.0"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "latinio"
