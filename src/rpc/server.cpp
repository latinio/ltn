...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* LTN features */
        {"latinio", "masternode", &masternode, true, true, false},
        {"latinio", "listmasternodes", &listmasternodes, true, true, false},
        {"latinio", "getmasternodecount", &getmasternodecount, true, true, false},
        {"latinio", "masternodeconnect", &masternodeconnect, true, true, false},
        {"latinio", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"latinio", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"latinio", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"latinio", "masternodecurrent", &masternodecurrent, true, true, false},
        {"latinio", "masternodedebug", &masternodedebug, true, true, false},
        {"latinio", "startmasternode", &startmasternode, true, true, false},
        {"latinio", "createmasternodekey", &createmasternodekey, true, true, false},
        {"latinio", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"latinio", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"latinio", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"latinio", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"latinio", "getmasternodescores", &getmasternodescores, true, true, false},
        {"latinio", "mnsync", &mnsync, true, true, false},
        {"latinio", "spork", &spork, true, true, false},
        {"latinio", "getpoolinfo", &getpoolinfo, true, true, false},
...
{
    return "> latinio-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:3588/\n";
}
