...
/* Latinio GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "LTN"
#define QAPP_ORG_DOMAIN "latinio.org"
#define QAPP_APP_NAME_DEFAULT "Latinio-Core"
#define QAPP_APP_NAME_TESTNET "Latinio-Core-testnet"
