...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("Latinio Core latinio-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  latinio-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded latinio transaction") + "\n" +
                               "  latinio-tx [options] -create [commands]   " + _("Create hex-encoded latinio transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded latinio transaction
